...
train_ds = DatasetSegmentation(config_file, processor, model="train")
valid_ds = DatasetSegmentation(config_file, processor, model="valid")
# Create a dataloader
...
for epoch in range(num_epochs):
    ...
    model_checkp.update(valid_loss)
    print(valid_loss)
